...
function applySafetyRules(params) {
    const reasons = [];
    const taperAndRaceWeeks = new Set(params.phasePlan.weeks.filter((week) => week.phase === "taper" || week.isRaceWeek).map((week) => week.weekIndex));
