...
function choosePlanType(input, classification) {
    ...
    if (input.raceDistance === "10K") {
        ...
        reasons.push(level === "beginner_plus" || level === "true_beginner"
    ...
    if (input.raceDistance === "HalfMarathon") {
        ...
        reasons.push(planType === "hm_target_time"
    ...
    const planType = input.goalType === "target_time" ? "marathon_target_time" : input.goalType === "improve_time" ? "marathon_improve" : "marathon_finish";
    reasons.push(planType === "marathon_target_time"
