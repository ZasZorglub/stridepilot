...
exports.buildReturnToRunningState = buildReturnToRunningState;
function buildReturnToRunningState(params) {
    ...
    const graduationEligible = Math.max(...params.curves.continuousCurve, params.input.currentContinuousRunMin) >= graduationContinuousMin &&
