...
const engine_v2_calibrated_1 = require("../src/lib/engine-v2-calibrated");
const OUTPUT_DIR = process.env.BENCHMARK_EXPORT_DIR
    ? path_1.default.resolve(process.cwd(), process.env.BENCHMARK_EXPORT_DIR)
    : path_1.default.join(process.cwd(), "exports", "engine-v2-calibrated-benchmark-set-1");
const fixtures = [
    {
...
function buildAnalysis(plan, fixture) {
    return {
        caseId: fixture.id,
        name: fixture.name,
...
function buildTextReport(plan, fixture) {
    const lines = [];
...
for (const fixture of fixtures) {
    const plan = (0, engine_v2_calibrated_1.buildTrainingPlan)(fixture.profile);
    const analysis = buildAnalysis(plan, fixture);
    const text = buildTextReport(plan, fixture);
    const jsonPath = path_1.default.join(OUTPUT_DIR, `${fixture.id}.json`);
    const txtPath = path_1.default.join(OUTPUT_DIR, `${fixture.id}.txt`);
    fs_1.default.writeFileSync(jsonPath, `${JSON.stringify(analysis, null, 2)}\n`, "utf8");
    fs_1.default.writeFileSync(txtPath, text, "utf8");
