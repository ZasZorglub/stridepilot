...
import { LiveWorkoutCard } from "./components/LiveWorkoutCardPreview";
import {
  FeedbackInsights,
  Goal,
  GoalType,
...
export default function Home() {
  ...
  const circularWorkoutCardState = useMemo(() => {
    if (currentStep?.type === "run") return "run";
    if (currentStep?.type === "walk") return "walk";
