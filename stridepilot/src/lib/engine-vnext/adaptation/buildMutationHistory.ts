...
export function buildBasePlanVersionMetadata(plan: EnginePlan): PlanVersionMetadata {
...
export function buildAdaptiveHistoryEntry(params: {
  plan: EnginePlan;
...
export function applyAdaptiveVersioning(params: {
  ...
  const versionMetadata: PlanVersionMetadata = params.historyEntry.applied
    ? {
        ...sourceVersion,
