import type { PhasePlan, PlanTypeDecision, RunnerClassification, RunnerInput, ValidationIssue } from "./models";

export function validateRunnerClassification(input: RunnerInput, classification: RunnerClassification): ValidationIssue[] {
...
export function validatePlanTypeDecision(input: RunnerInput, classification: RunnerClassification, decision: PlanTypeDecision): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
...
export function validatePhasePlan(input: RunnerInput, classification: RunnerClassification, decision: PlanTypeDecision, phasePlan: PhasePlan): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
