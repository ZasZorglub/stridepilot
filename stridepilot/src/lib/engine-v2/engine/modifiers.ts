import type { ProgressionCurves, RunnerClassification, RunnerInput } from "../models";
...
export function applyRunnerModifiers(params: {
  input: RunnerInput;
  ...
  if (
    params.classification.traits.modifiers.includes("performance_bias") &&
