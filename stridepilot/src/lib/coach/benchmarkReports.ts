...
import type { Goal, RunnerProfile as AppRunnerProfile, WorkoutSession as AppWorkoutSession, WorkoutStep } from "@/lib/types";
...
function buildCoachPlan(fixture: BenchmarkReportFixture): { coachPlan: CoachTrainingPlan; appPlan: ReturnType<typeof mapCoachPlanToAppPlan>; coachProfile: ReturnType<typeof interpretRunnerProfile> } {
  ...
  return {
    coachPlan,
    appPlan: mapCoachPlanToAppPlan(coachPlan, coachPlan.goal),
    coachProfile,
  };
}
...
function analyzeSessionShape(appSession: AppWorkoutSession, coachSession: CoachWorkoutSession) {
...
): { warnings: PlanQualityWarningType[]; diagnostics: BenchmarkQualityDiagnostics } {
